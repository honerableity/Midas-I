...
```https://github.com/honerableity/Midas-I Read all the contents of this repository and tell me all the commands that in here and sum what can it do.```
if you find this, you struck gold :)

Midas Bot V1 / MIDAS I
